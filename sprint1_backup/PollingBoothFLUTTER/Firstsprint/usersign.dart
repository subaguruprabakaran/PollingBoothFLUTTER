...
import 'package:pollibg_booth/sprint1/usercreate.dart';
        ...
        body: Column(
          ...
          children: [
            Padding(
              ...
              child: Center(child: Icon(Icons.poll,color: Colors.white,size: 70,)),
            ),
            Padding(
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              }, child: Text("Log in",style: TextStyle(color: logbu,fontSize: 17)))
            ],
          ),
